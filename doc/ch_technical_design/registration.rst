...
1. Providers attached to a source will be automatically registered for any data products that cannot be provided by an explicit provider or a computational node.
