...
.. [#label] The specific rules by which the :math:`\textit{label}` operator can be used are given in :numref:`ch_technical_design/data_product_management:Data Product Management`.
