...
One subsystem make make us of the functionality provided by another subsystem only through the public interface of the other subsystem.
The set of subsystems can have no circular dependencies.
...
This chapter of the document enumerates the subsystems, and descibes their responsibliities and interactions.
